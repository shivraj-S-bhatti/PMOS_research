...
The professor-facing STAT report is generated by the R script and requires the
R package `readxl`. The Python script is retained for the broader exploratory
